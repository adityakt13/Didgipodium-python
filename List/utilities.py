...
y = x.copy() # cretaes a copy of x
print(x)
print(y)

c1 = x.count(1) # counts the number of occurences of 1 in x
print(f"1 occurs {c1} times in x")

x.sort() # sorts list in ascending order
print(x)
...
i12 = y.index(12) # returns the index of first occurence of 12
